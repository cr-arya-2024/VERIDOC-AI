    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-20 animate-in fade-in duration-700">
      ...
      {result.rawAnalysis ? (
        <Card title="Detailed Analysis">
          <div className="text-slate-300 leading-relaxed whitespace-pre-wrap font-mono text-sm max-h-[600px] overflow-y-auto">
            {result.rawAnalysis}
          </div>
        </Card>
      ) : (
            ...
            <Card title={t('design_metrics')} className="bg-indigo-900/10 border-indigo-500/20">
              <div className="space-y-4">
                <div className="flex justify-between items-center py-2 border-b border-slate-800">
                  ...
                  <span className="text-white font-mono">{result.complexity?.estimatedGates || 'N/A'}</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-slate-800">
                ...
                <div className="flex justify-between items-center py-2 border-b border-slate-800">
                  ...
                  <span className="text-white font-mono">{result.complexity?.clockDomains || 0}</span>
                </div>
              </div>
            </Card>
